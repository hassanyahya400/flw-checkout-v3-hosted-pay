export const getEnvironmentData = (environment = "Staging") => {
    ...
    switch (environment) {
        case "Staging":
          ...
          data.hosted_url = import.meta.env.VITE_STAGING_CHECKOUT_HOSTED_PAY_URL
          data.checkout_url = import.meta.env.VITE_STAGING_CHECKOUT_URL
        ...
        case "Pilot":
            ...
            data.hosted_url = import.meta.env.VITE_PILOT_CHECKOUT_HOSTED_PAY_URL
            data.checkout_url = import.meta.env.VITE_PILOT_CHECKOUT_URL
        ...
        case "Production":
            ...
            data.hosted_url = import.meta.env.VITE_PRODUCTION_CHECKOUT_HOSTED_PAY_URL
            data.checkout_url = import.meta.env.VITE_PRODUCTION_CHECKOUT_URL
